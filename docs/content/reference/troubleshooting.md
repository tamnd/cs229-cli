...
Most of these come down to network reality or how cs229 serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

cs229 rate-limits like any public site. cs229 already paces
...
Where a surface is gated, cs229 reads a cookie or token you supply
...
`cs229`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cs229 actually did
